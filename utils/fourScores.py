...
for i in range(0, len(files1)):
  ...
  if ((not f1max1 == 0 and not str(f1max1) == 'nan') or \
    ...
    count += 1
    str1 += files1[i][len(fname1):]
    str1 += ','
    #print str(f1max1) + ',' + str(f1max2) + ',' + f1o + ',' + f1re
    if hasone == 1 and hastwo == 1:
      print files1[i][len(fname1):] + '\t' + f1o + '\t' + f1re + '\t' + str((f11 + f12)/2) + '\t' + str((f1max1 + f1max2)/2)
    elif hasone == 1:
      print files1[i][len(fname1):] + '\t' + f1o + '\t' + f1re + '\t' + str(f11) + '\t' + str(f1max1)
    else:
      print files1[i][len(fname1):] + '\t' + f1o + '\t' + f1re + '\t' + str(f12) + '\t' + str(f1max2)
print str1
